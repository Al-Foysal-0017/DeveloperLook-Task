...
const MobileMenu = ({ isOpen, setIsOpen }) => {
  return (
    ...
    style={{background:"#FCB8FA"}}
      className={`overflow-hidden md:hidden inline fixed inset-0 z-[100] bg-[#FCB8FA] transition-transform duration-500 ease-in-out ${
    ...
    >
      ...
      <div className="flex justify-between items-start px-[5vw] pt-[5vw]">
        {/* Branding Logo */}
        <div className="text-[8vw] tracking-tighter leading-none ">
        <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 208 84"
              className="w-[clamp(8rem,10vw,12rem)] h-auto"
              fill="none"
            >
      ...
      {/* --- Menu Links Section --- */}
      <div className="mt-16 flex flex-col items-center justify-center h-[70%] gap-[3vw] px-[5vw]">
