    ...
    <Container>
      <section className="relative pt-[4vw] pb-[5vw] overflow-hidden">
        ...
        <div className="w-full mt-[5vw] flex flex-nowrap justify-center items-end gap-[4vw]">
          ...
          <div className="relative w-[23vw] h-[32vw] min-h-[380px] max-h-[580px] rounded-[3vw] overflow-hidden rotate-3 hover:rotate-0 transition-all duration-500 shadow-2xl z-40 -ml-[4vw]">
            {!loaded && (
              <img
          ...
          <div 
            ...
            className="relative w-[23vw] h-[32vw] min-h-[350px] max-h-[550px] rounded-[3vw] p-[2vw] flex flex-col justify-between -rotate-6 hover:rotate-0 transition-all duration-500 shadow-2xl z-40 -ml-[4vw]"
          >
          ...
          <div className="relative w-[23vw] h-[32vw] min-h-[380px] max-h-[580px] rounded-[3vw] overflow-hidden rotate-2 hover:rotate-0 transition-all duration-500 shadow-2xl z-50 -ml-[4vw]">
            {!loaded2 && (
              <img
